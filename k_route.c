...
int k_add_rte(u_int32_t dst, u_int32_t gw, u_int32_t nm, short int hcnt, unsigned int ifindex)
{
...
int k_chg_rte(u_int32_t dst, u_int32_t gw, u_int32_t nm, short int hcnt, unsigned int ifindex)
{
    int ret;
