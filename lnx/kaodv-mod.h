...
static inline int ifi_add(struct net_device *dev)
{
	struct if_info *ifi;
...
static inline void ifi_purge(void)
{
...
static inline int ifi_from_ifindex(struct in_addr *ifa, struct in_addr *bc,
				   int ifindex)
{
