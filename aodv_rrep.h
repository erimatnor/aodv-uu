...
void rrep_send(rt_table_t * rev_rt, rt_table_t * fwd_rt);
void rrep_forward(RREP * rrep, rt_table_t * rev_rt, rt_table_t * fwd_rt,
		  int ttl);
void rrep_process(RREP * rrep, int rreplen, u_int32_t ip_src, u_int32_t ip_dst,
