...
static void packet_input(int fd)
{
	...
	fprintf(stderr,
		"ERROR packet_input: Check that the ip_queue_aodv.o module is loaded.\n");
	die(h);
    }
    ...
    /* Hmmm, how can one be sure that this IP packet was actually
	...
	rt_table_update_timeout(rev_rt,
